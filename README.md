...
| 이름   | 역할      | 개발 내용                                                    |
| ------ | --------- | ------------------------------------------------------------ |
| 윤성빈 | Front-end | - 주제 기획 및 기능 설계, 와이어프레임 제작<br />- Axios를 이용한 서버와 데이터 통신<br />- 'Styled-components'를 이용한 CSS-in-JS 스타일링 구현<br />- 지역 추천 테스트<br />&emsp;- 한반도 지도 svg 기반 지역 선택 기능<br />&emsp;- 지역 별 메인 화면<br />&emsp;- 지역 별 숙소 / 액티비티 랜덤 추천 기능 구현<br />- 사용자용 메인 화면<br />&emsp;- Kakao Map API를 이용한 주변 편의 시설 지도<br />&emsp;- 오늘 / 내일 나의 일정 캐러셀 구현<br />- 북마크<br />&emsp;- 숙소 / 액티비티 좋아요 기능 구현<br />- 여행 일정 공유<br />&emsp;- 여행스타그램 태그 별 검색 기능 구현<br />- 숙소 / 액티비티 페이지<br />&emsp;- 목록 페이지 및 상세 페이지<br />- 예약 페이지<br />&emsp;- datepicker를 이용한 예약 기능 구현 |
